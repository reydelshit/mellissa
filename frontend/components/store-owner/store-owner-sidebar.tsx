...
import { Home, Store, ShoppingBag, BarChart3, Settings, LogOut, Tag, Percent } from "lucide-react"
  ...
  const SidebarContent = () => (
    <div className="flex h-full flex-col gap-2">
      <div className="flex h-14 items-center border-b px-4">
        <Link href="/store-owner" className="flex items-center gap-2 font-semibold">
